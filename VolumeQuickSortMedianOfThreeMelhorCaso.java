...
public class VolumeQuickSortMedianOfThreeMelhorCaso {
    
    public static void main(String[] args) {
        String csvFile = "C:\\Users\\rodri\\Desktop\\Estudos\\Projeto LEDA\\b3stocks_volume_quickSortMedianOfThree_medioCaso.csv"; // caminho para o arquivo CSV
        ...
        try {
            ...
            writeCSV("b3stocks_volume_quickSortMedianOfThree_melhorCaso.csv", data);
            System.out.println("Valores ordenados foram escritos no arquivo 'b3stocks_volume_quickSortMedianOfThree_melhorCaso.csv'.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
