...
public class VolumeMergeSort {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            writeCSV("b3stocks_volume_mergeSort_medioCaso.csv", data);
            System.out.println("Valores ordenados foram escritos no arquivo 'b3stocks_volume_mergeSort_medioCaso.csv'.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
