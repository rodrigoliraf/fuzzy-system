...
public class TickerHeapSort {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            heapSort(data);
            writeCSV("b3stocks_ticker_heapSort_medioCaso.csv", data);
            System.out.println("Valores ordenados foram escritos no arquivo 'b3stocks_ticker_heapSort_medioCaso.csv'.");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    // Método para ordenar uma matriz de strings usando o algoritmo Heap Sort
